      ...
      <div className="flex flex-col content-center text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center">
          ...
          <div className="font-light p-4 sm:max-w-md my-auto">
            ...
            <p>
              No formal art education should never stop anybody from creating.
              If your soul desires to make a world a more beautiful place -
              please keep on doing it. This can become the mission of your life.
            </p>
            <p>
